...
const CompEditSlidePrincipal = () => {
    ...
    // Función para manejar la actualización del slide
    const update = async (e) => {
        ...
        try {
            ...
            navigate('/slide-principal');  // Redirigir después de la actualización
        } catch (error) {
    ...
    // Efecto para obtener los datos del slide por ID
    useEffect(() => {
        const token = localStorage.getItem('token');
        if (!token) {
            alert('Token no encontrado. Por favor, inicie sesión');
        ...
        <div className="container mt-4 d-flex justify-content-center">
            <div className="card shadow-sm col-md-8 col-12">
                <div className="card-header bg-dark text-white">
                    <h3 className="mb-0">Editar Slide Principal</h3>
                </div>
...
export default CompEditSlidePrincipal;
